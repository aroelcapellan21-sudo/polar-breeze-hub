...
export default function Choferes() {
  ...
  const guardar = async () => {
    ...
    try {
      ...
      // session/despacho — actualizar totales
      try {
      ...
      // talonario — registro de movimiento
      await addDoc(collection(db, "talonario"), {
        choferId:          sel.uid,
        choferNombre:      sel.nombre,
        choferFicha:       sel.ficha ?? "",
        productos,
        observaciones:     observaciones || null,
        tipo:              "retirada",
        fuente:            "despacho",
      ...
      <div className="grid lg:grid-cols-3 gap-5">
        ...
        <div className="bg-white rounded-xl shadow-sm p-5 space-y-4">
          <div className="flex items-center justify-between">
            ...
            {productos.length > 0 && (
              <button
                ...
                className="text-xs text-gray-400 hover:text-red-400 active:scale-95
          ...
          {!sel ? (
            ...
            <>
              {/* showVisto=true para ✅/❌, showPrecio=false — no puede editar precios */}
              <ProductTable
                productos={productos}
